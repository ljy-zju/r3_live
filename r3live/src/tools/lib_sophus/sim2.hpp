...
namespace Sophus
{
template <class Scalar_, int Options = 0> class Sim2;
...
template <class Scalar_, int Options> struct traits<Sophus::Sim2<Scalar_, Options>>
{
...
///
template <class Derived> class Sim2Base
{
  public:
    ...
    template <typename OtherDerived> using Sim2Product = Sim2<ReturnScalar<OtherDerived>>;
    ...
    ///
    template <class NewScalarType> SOPHUS_FUNC Sim2<NewScalarType> cast() const
    {
    ...
    ///
    template <class OtherDerived> SOPHUS_FUNC Sim2Base<Derived> &operator=(Sim2Base<OtherDerived> const &other)
    {
        rxso2() = other.rxso2();
...
template <class Scalar_, int Options> class Sim2 : public Sim2Base<Sim2<Scalar_, Options>>
{
  public:
    ...
    ///
    template <class UniformRandomBitGenerator> static Sim2 sampleUniform(UniformRandomBitGenerator &generator)
    {
...
template <class Scalar, int Options> Sim2<Scalar, Options>::Sim2() : translation_(TranslationMember::Zero())
{
    static_assert(std::is_standard_layout<Sim2>::value, "Assume standard layout for the use of offsetof check below.");
    static_assert(offsetof(Sim2, rxso2_) + sizeof(Scalar) * RxSO2<Scalar>::num_parameters ==
