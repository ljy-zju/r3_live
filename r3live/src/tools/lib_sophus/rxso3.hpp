...
namespace Sophus
{
template <class Scalar_, int Options = 0> class RxSO3;
...
template <class Scalar_, int Options_> struct traits<Sophus::RxSO3<Scalar_, Options_>>
{
...
/// this threshold.
template <class Derived> class RxSO3Base
{
  public:
    ...
    template <typename OtherDerived> using RxSO3Product = RxSO3<ReturnScalar<OtherDerived>>;
    ...
    ///
    template <class NewScalarType> SOPHUS_FUNC RxSO3<NewScalarType> cast() const
    {
    ...
    ///
    template <class OtherDerived> SOPHUS_FUNC RxSO3Base<Derived> &operator=(RxSO3Base<OtherDerived> const &other)
    {
...
template <class Scalar_, int Options> class RxSO3 : public RxSO3Base<RxSO3<Scalar_, Options>>
{
  public:
    ...
    ///
    template <class D> SOPHUS_FUNC explicit RxSO3(Eigen::QuaternionBase<D> const &quat) : quaternion_(quat)
    {
    ...
    ///
    template <class UniformRandomBitGenerator> static RxSO3 sampleUniform(UniformRandomBitGenerator &generator)
    {
