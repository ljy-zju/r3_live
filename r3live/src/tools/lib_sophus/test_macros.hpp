...
template <class Scalar> class Pretty
{
  public:
...
template <class Scalar, int M, int N> class Pretty<Eigen::Matrix<Scalar, M, N>>
{
  public:
...
template <class T> std::string pretty(T const &v)
{
...
#define SOPHUS_TEST(passed, condition, ...)                                                                            \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            std::string msg =                                                                                          \
                Sophus::details::FormatString("condition ``%`` is false\n", SOPHUS_STRINGIFY(condition));              \
...
#define SOPHUS_TEST_EQUAL(passed, left, right, ...)                                                                    \
    ...
    {                                                                                                                  \
        if (left != right)                                                                                             \
        {                                                                                                              \
            std::string msg = Sophus::details::FormatString("% (=%) is not equal to % (=%)\n", SOPHUS_STRINGIFY(left), \
...
#define SOPHUS_TEST_NEQ(passed, left, right, ...)                                                                      \
    ...
    {                                                                                                                  \
        if (left == right)                                                                                             \
        {                                                                                                              \
            std::string msg = Sophus::details::FormatString("% (=%) shoudl not be equal to % (=%)\n",                  \
...
#define SOPHUS_TEST_APPROX(passed, left, right, thr, ...)                                                              \
    ...
    {                                                                                                                  \
        ...
        if (!(nrm < (thr)))                                                                                            \
        {                                                                                                              \
            std::string msg = Sophus::details::FormatString("% (=%) is not approx % (=%); % is %; nrm is %\n",         \
                                                            SOPHUS_STRINGIFY(left), Sophus::details::pretty(left),     \
                                                            SOPHUS_STRINGIFY(right), Sophus::details::pretty(right),   \
