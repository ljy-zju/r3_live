...
template <class Scalar_, int Options_> struct traits<Sophus::RxSO2<Scalar_, Options_>>
{
...
/// this threshold.
template <class Derived> class RxSO2Base
{
  public:
    ...
    template <typename OtherDerived> using RxSO2Product = RxSO2<ReturnScalar<OtherDerived>>;
    ...
    ///
    template <class NewScalarType> SOPHUS_FUNC RxSO2<NewScalarType> cast() const
    {
    ...
    ///
    template <class OtherDerived> SOPHUS_FUNC RxSO2Base<Derived> &operator=(RxSO2Base<OtherDerived> const &other)
    {
...
template <class Scalar_, int Options> class RxSO2 : public RxSO2Base<RxSO2<Scalar_, Options>>
{
  public:
    ...
    ///
    template <class OtherDerived> SOPHUS_FUNC RxSO2(RxSO2Base<OtherDerived> const &other) : complex_(other.complex())
    {
    }
    ...
    ///
    template <class UniformRandomBitGenerator> static RxSO2 sampleUniform(UniformRandomBitGenerator &generator)
    {
