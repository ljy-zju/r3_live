...
///
template <class T> Vector2<T> normalFromSO2(SO2<T> const &R_foo_line)
{
...
///
template <class T> SO2<T> SO2FromNormal(Vector2<T> normal_foo)
{
...
///
template <class T> Vector3<T> normalFromSO3(SO3<T> const &R_foo_plane)
{
...
///
template <class T> SO3<T> SO3FromNormal(Vector3<T> const &normal_foo)
{
...
///
template <class T> Line2<T> lineFromSE2(SE2<T> const &T_foo_line)
{
...
///
template <class T> SE2<T> SE2FromLine(Line2<T> const &line_foo)
{
...
///
template <class T> Plane3<T> planeFromSE3(SE3<T> const &T_foo_plane)
{
...
/// Note: The plane is defined by XY-plane of the frame ``plane``.
///
template <class T> SE3<T> SE3FromPlane(Plane3<T> const &plane_foo)
{
...
///
template <class T, int N> Eigen::Hyperplane<T, N> makeHyperplaneUnique(Eigen::Hyperplane<T, N> const &plane)
{
    if (plane.offset() >= 0)
    {
        return plane;
