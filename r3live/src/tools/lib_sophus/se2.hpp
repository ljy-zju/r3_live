...
namespace Sophus
{
template <class Scalar_, int Options = 0> class SE2;
...
template <class Scalar_, int Options> struct traits<Sophus::SE2<Scalar_, Options>>
{
...
///
template <class Derived> class SE2Base
{
  public:
    ...
    template <typename OtherDerived> using SE2Product = SE2<ReturnScalar<OtherDerived>>;
    ...
    ///
    template <class NewScalarType> SOPHUS_FUNC SE2<NewScalarType> cast() const
    {
    ...
    ///
    template <class OtherDerived> SOPHUS_FUNC SE2Base<Derived> &operator=(SE2Base<OtherDerived> const &other)
    {
        so2() = other.so2();
    ...
    SOPHUS_FUNC void setRotationMatrix(Matrix<Scalar, 2, 2> const &R)
    {
        ...
        typename SO2Type::ComplexTemporaryType const complex(Scalar(0.5) * (R(0, 0) + R(1, 1)),
...
template <class Scalar_, int Options> class SE2 : public SE2Base<SE2<Scalar_, Options>>
{
  public:
    ...
    ///
    template <class UniformRandomBitGenerator> static SE2 sampleUniform(UniformRandomBitGenerator &generator)
    {
    ...
    ///
    template <class T0, class T1> static SOPHUS_FUNC SE2 trans(T0 const &x, T1 const &y)
    {
...
template <class Scalar, int Options> SE2<Scalar, Options>::SE2() : translation_(TranslationMember::Zero())
{
