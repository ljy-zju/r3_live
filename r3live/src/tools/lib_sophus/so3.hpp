...
namespace Sophus
{
template <class Scalar_, int Options = 0> class SO3;
...
template <class Scalar_, int Options_> struct traits<Sophus::SO3<Scalar_, Options_>>
{
...
template <class Derived> class SO3Base
{
  public:
    ...
    ///
    template <class S = Scalar> SOPHUS_FUNC enable_if_t<std::is_floating_point<S>::value, S> angleX() const
    {
    ...
    ///
    template <class S = Scalar> SOPHUS_FUNC enable_if_t<std::is_floating_point<S>::value, S> angleY() const
    {
        Sophus::Matrix3<Scalar> R = matrix();
    ...
    ///
    template <class S = Scalar> SOPHUS_FUNC enable_if_t<std::is_floating_point<S>::value, S> angleZ() const
    {
        Sophus::Matrix3<Scalar> R = matrix();
    ...
    ///
    template <class NewScalarType> SOPHUS_FUNC SO3<NewScalarType> cast() const
    {
    ...
    ///
    template <class OtherDerived> SOPHUS_FUNC SO3Base<Derived> &operator=(SO3Base<OtherDerived> const &other)
    {
...
template <class Scalar_, int Options> class SO3 : public SO3Base<SO3<Scalar_, Options>>
{
  public:
    ...
    ///
    template <class D> SOPHUS_FUNC explicit SO3(Eigen::QuaternionBase<D> const &quat) : unit_quaternion_(quat)
    {
    ...
    ///
    template <class UniformRandomBitGenerator> static SO3 sampleUniform(UniformRandomBitGenerator &generator)
    {
