...
namespace Sophus
{
template <class Scalar_, int Options = 0> class SO2;
...
template <class Scalar_, int Options_> struct traits<Sophus::SO2<Scalar_, Options_>>
{
...
template <class Derived> class SO2Base
{
  public:
    ...
    ///
    template <class NewScalarType> SOPHUS_FUNC SO2<NewScalarType> cast() const
    {
    ...
    ///
    template <class OtherDerived> SOPHUS_FUNC SO2Base<Derived> &operator=(SO2Base<OtherDerived> const &other)
    {
...
template <class Scalar_, int Options> class SO2 : public SO2Base<SO2<Scalar_, Options>>
{
  public:
    ...
    ///
    template <class D> SOPHUS_FUNC explicit SO2(Eigen::MatrixBase<D> const &complex) : unit_complex_(complex)
    {
    ...
    ///     | -1  0 |
    ///
    SOPHUS_FUNC static Transformation generator()
    {
        return hat(Scalar(1));
    }
    ...
    ///
    template <class UniformRandomBitGenerator> static SO2 sampleUniform(UniformRandomBitGenerator &generator)
    {
