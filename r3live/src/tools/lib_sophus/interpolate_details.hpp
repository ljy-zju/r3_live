...
template <class Group> struct Traits;

template <class Scalar> struct Traits<SO2<Scalar>>
{
...
template <class Scalar> struct Traits<RxSO2<Scalar>>
{
    static bool constexpr supported = true;
...
template <class Scalar> struct Traits<SO3<Scalar>>
{
    static bool constexpr supported = true;
...
template <class Scalar> struct Traits<RxSO3<Scalar>>
{
    static bool constexpr supported = true;
...
template <class Scalar> struct Traits<SE2<Scalar>>
{
    static bool constexpr supported = true;
...
template <class Scalar> struct Traits<SE3<Scalar>>
{
    static bool constexpr supported = true;
...
template <class Scalar> struct Traits<Sim2<Scalar>>
{
    static bool constexpr supported = true;
...
template <class Scalar> struct Traits<Sim3<Scalar>>
{
    static bool constexpr supported = true;
