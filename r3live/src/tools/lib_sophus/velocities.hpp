...
//
template <class Scalar> Vector3<Scalar> transformVelocity(SO3<Scalar> const &foo_R_bar, Vector3<Scalar> const &vel_bar)
{
...
// Note: vel_bar can be either a linear or a rotational velocity vector.
//
template <class Scalar> Vector3<Scalar> transformVelocity(SE3<Scalar> const &foo_T_bar, Vector3<Scalar> const &vel_bar)
{
