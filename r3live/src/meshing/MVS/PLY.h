...
class PLY
{
  ...
  public:
    ...
    static inline bool equal_strings(const char *s1, const char *s2)
    {
  ...
  protected:
    ...
    template <typename T> static inline T ValueType2Type(const ValueType &val, int type)
    {
        switch (type)
        {
        case Int8:
