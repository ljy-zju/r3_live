...
{
    template <typename TYPE> static inline void Copy(TYPE *&ptrLeft, TYPE *&ptrRight)
    {
        ptrLeft = ptrRight;
        ptrRight = NULL;
    }
...
template <typename TYPE, typename CopyPolicy = AutoPtrMoveCopy> class CAutoPtr
{
  private:
    typedef TYPE Type;
...
template <class TYPE> class CAutoPtrArr
{
  private:
    typedef TYPE Type;
    typedef TYPE *TypePtr;
