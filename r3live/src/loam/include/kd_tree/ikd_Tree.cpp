...
void KD_TREE::print_tree(int index, FILE *fp, float x_min, float x_max, float y_min, float y_max, float z_min,
                         float z_max)
{
    pthread_mutex_lock(&working_flag_mutex);
...
void KD_TREE::print_treenode(KD_TREE_NODE *root, int index, FILE *fp, float x_min, float x_max, float y_min,
