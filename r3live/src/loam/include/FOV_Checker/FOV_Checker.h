...
class FOV_Checker
{
  public:
    ...
    void check_fov(Eigen::Vector3d cur_pose, Eigen::Vector3d axis, double theta, double depth,
    ...
    bool check_line(Eigen::Vector3d cur_pose, Eigen::Vector3d axis, double theta, double depth, Eigen::Vector3d line_p,
                    Eigen::Vector3d line_vec);
